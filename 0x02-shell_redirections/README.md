# <p align='center'>0x02-shell_redirections</p>
...
Solution: [0-hello_world](0-hello_world).
...
Solution: [1-confused_smiley](1-confused_smiley).
...
Solution: [2-hellofile](2-hellofile).
...
Solution: [3-twofiles](3-twofiles).
...
Solution: [4-lastlines](4-lastlines).
...
Solution: [5-firstlines](5-firstlines).
...
Solution: [6-third_line](6-third_line).
...
Solution: [8-cwd_state](8-cwd_state).
...
Solution: [9-duplicate_last_line](9-duplicate_last_line).
...
Solution: [10-no_more_js](10-no_more_js).
...
Solution: [11-directories](11-directories).
...
Solution: [12-newest_files](12-newest_files).
...
Solution: [14-findthatword](14-findthatword).
...
Solution: [15-countthatword](15-countthatword).
...
Solution: [16-whatsnext](16-whatsnext).
...
Solution: [17-hidethisword](17-hidethisword0).
...
Solution: [18-letteronly](18-letteronly).
...
Solution: [21-reverse](21-reverse).
...
Solution: [22-users_and_homes](22-users_and_homes).
...
Soluton: [100-empty_casks](100-empty_casks).
...
Solution: [102-acrostic](102-acrostic).
...
Solution: [103-the_biggest_fan](103-the_biggest_fan).